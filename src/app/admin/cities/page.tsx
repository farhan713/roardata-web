    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-white tracking-tight">Cities</h1>
                    <p className="text-slate-400 mt-1">Manage the geographic locations served by ROAR DATA.</p>
                </div>
                <Link
