    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-black tracking-tight">Insights</h1>
                    <p className="text-black/70 mt-1">Manage articles, blog posts, and thought leadership content.</p>
                </div>
                <Link
                    ...
                    <table className="w-full text-left text-sm text-black/70">
                        ...
                        <tbody className="divide-y divide-border">
                            {insights.map((insight: any) => (
                                <tr key={insight.id} className="hover:bg-secondary/50 transition-colors">
                                    <td className="px-6 py-4 font-medium text-black">
                                        <div>{insight.title}</div>
                                        <div className="text-xs font-mono text-primary mt-1">/{insight.slug}</div>
                                    </td>
